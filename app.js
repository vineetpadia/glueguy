...
const PROFILE_LIBRARY = {
  ...
  hybridRepair: {
    chemistry: "Flexible hybrid repair adhesive",
    cureFamily: "Hybrid polymer adhesive",
    cureDetail: "One-part clear hybrid adhesive; cure depends on substrate and ambient conditions",
    serviceMin: -40,
    serviceMax: 120,
    viscosityClass: "medium",
    thixotropic: false,
    ...
    fixtureTime: 25,
    lapShear: 2,
    stress: buildStress({ shear: 4, peel: 5, impact: 4 }),
    environment: buildEnvironment({ humidity: 0.7, fuel: 0.2, immersion: 0.35 }),
    substrates: buildRatings({ wood: 6, glass: 7, metal: 6, abs: 5, pvc: 5, rubber: 5, fabric: 4 }, 1),
    summary: "Flexible clear hybrid adhesive for household repairs and transparent materials.",
    cautions: ["Not for structural applications; follow product-specific cure and substrate guidance."],
  },
  reusablePutty: {
    chemistry: "Reusable pressure-sensitive putty",
    cureFamily: "Pressure-sensitive adhesive",
    cureDetail: "Reusable tacky putty; adhesion depends on contact pressure and surface condition",
    serviceMin: -20,
    serviceMax: 50,
    viscosityClass: "very-high",
    thixotropic: true,
    ...
    fixtureTime: 1,
    lapShear: 0.1,
    stress: buildStress({ shear: 1, peel: 2, impact: 0 }),
    environment: buildEnvironment({ humidity: 0.35, fuel: 0.05, immersion: 0 }),
    substrates: buildRatings({ paper: 7, wood: 3, glass: 3, metal: 3, abs: 3, pvc: 3 }, 0),
    summary: "Reusable putty for temporary lightweight mounting on clean, dry surfaces.",
    cautions: ["Do not use for structural or overhead mounting; may leave marks on some surfaces."],
  },
  pressureSensitiveDots: {
    chemistry: "Pressure-sensitive adhesive dots",
    cureFamily: "Pressure-sensitive adhesive",
    cureDetail: "Instant tack under pressure",
    serviceMin: -20,
    serviceMax: 50,
    viscosityClass: "very-high",
    thixotropic: true,
    ...
    fixtureTime: 0,
    lapShear: 0.1,
    stress: buildStress({ shear: 1.5, peel: 2.5, impact: 0.5 }),
    environment: buildEnvironment({ humidity: 0.3, fuel: 0, immersion: 0 }),
    substrates: buildRatings({ paper: 7, wood: 2, glass: 2, metal: 2, abs: 2 }, 0),
    summary: "Instant pressure-sensitive dots for lightweight household and craft mounting.",
    cautions: ["No published load rating; do not use for structural or overhead mounting."],
  },
  craftPva: {
    chemistry: "Craft PVA",
    cureFamily: "PVA",
...
function populateReferenceFilters() {
  ...
  if (referenceMakerSelect) {
    const makers = Array.from(new Set(browseProducts.map((product) => product.maker).filter(isManufacturerLabel)))
...
const DETAIL_EVIDENCE_FIELDS = [
  ...
  ["Historical TDS impact strength", "tdsImpactStrength"],
  ["Historical TDS viscosity range (cP)", "tdsViscosityRangeCps"],
  ["Historical TDS service-temperature range (°F)", "tdsServiceTemperatureRangeF"],
  ...
  ["TDS delivery time (seconds)", "tdsDeliveryTimeSeconds"],
  ["TDS stated set time (seconds)", "tdsSetTimeSeconds"],
  ["TDS press-hold time (seconds)", "tdsHandPressureTimeRangeSeconds"],
  ...
  ["TDS maximum storage temperature (°F)", "tdsShelfStorageMaxF"],
  ["TDS food-contact statement", "tdsFoodContact"],
  ...
  ["TDS water-resistance note", "waterResistanceNote"],

...
async function loadSelectorCatalog() {
  ...
  try {
    ...
    try {
      const leadsResponse = await fetch("./data/autonomous-discovered-products.json?v=official-tds-coverage-20260923-3m-dap-permatex-ca-glues-rtv-selleys-direct-tds-8");
      if (leadsResponse.ok) {

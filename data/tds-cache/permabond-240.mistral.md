...
Cyanoacrylate Technical Datasheet
...
PERMABOND® 240 is a high-viscosity product useful in large gap applications. It is ideal for porous substrates. It is fast-setting and suitable for use on plastics, rubbers and metals. Cyanoacrylate adhesives are single component adhesives that polymerize rapidly when pressed into a thin film between parts. The moisture adsorbed on the surface initiates the curing of the adhesive. Strong bonds are developed extremely fast and on a great variety of materials. These properties make Permabond® cyanoacrylates the ideal adhesives for high-speed production lines.

## Typical Physical Properties of Uncured Adhesive
...
|  Maximum gap fill | 0.4 mm 0.017 in  |
| --- | --- |
|  Fixture / handling time* (0.3 N/mm² shear strength is achieved) | 15-20 seconds (Steel)
...
|  Shear strength* (ISO 4587) | Steel | 21-25 N/mm² (3000-3600 psi)  |
| --- | --- | --- |
|   |  Aluminium | 8-9 N/mm² (1200-1300 psi)  |
|   |  Zinc | 10 N/mm² (1450 psi)  |
|   |  ABS | >8 N/mm² (>1200 psi) SF**  |
|   |  PVC | >11 N/mm² (>1600 psi) SF**  |
|   |  PC | >5 N/mm² (>700 psi) SF**  |
|   |  Phenolic | 14 N/mm² (2000 psi)  |
...
*"Hot strength" shear strength tests performed on mild steel. 24-hour cure at room-temperature and conditioned to pull-temperature for 30 minutes before testing. Permabond® 240 can withstand higher temperatures for brief periods (such as for paint-baking and wave soldering processes) provided the joint is not unduly stressed.
...
Specimens were immersed for 1000 hours at $22^{\circ}C$ (unless otherwise stated).
...
Full information can be obtained from the Safety Datasheet. This Technical Datasheet (TDS) offers guideline information and does not constitute a specification.
...
4. Do not disturb or re-align until sufficient strength is achieved, normally within a few seconds.
...
Cyanoacrylate directions for use: https://youtu.be/PiPzutdRmsk

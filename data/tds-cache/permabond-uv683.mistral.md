...
UV683 can withstand higher temperatures for brief periods (such as for paint baking and wave soldering processes) providing the joint is not unduly stressed. The minimum temperature the cured adhesive can be exposed to is $-55^{\circ}\mathrm{C}$ ($-67^{\circ}\mathrm{F}$) depending on the materials being bonded.

...
SELECTOR_PRODUCT_FIELDS = {
    ...
    "tdsLapShearTestMethod",
    "lapShearProfilesMPa",
    "lapShearTestMethod",
    "tdsFixtureTimeRangeSeconds",
    "tdsImpactStrength",
    "tdsShelfLife",
    "tdsViscosityCpsAt375F",
    ...
    "paintable",
    "tdsHeatResistanceF",
    "tdsBallAndRingMeltPointF",
    "tdsStorageLifeYears",
    "tdsShelfStorageMaxF",
    "tdsFoodContact",
    "tdsOverlapShearMethodNote",
    "tdsCompressionShearStrengthPsi",
    "tdsCompressionShearTestMethod",
    "tdsStrengthDevelopmentPsi",
    "tdsOverlapTensileStrengthPsiProfiles",
    "tdsBondStrengthTestConditions",
    "openTimeMinutes",
    ...
    "legacyDataRevision",
    "currentWebPageTensileStrengthPsi",
    "currentWebPageTensileStrengthNote",
    "maximumUseTempC",
    "maximumUseTempF",
